...
Selamat datang di **ANTIGRAVITY Workspace Hub**! Workspace ini dirancang sebagai repositori pusat (monorepo & multirepo hub) yang mengintegrasikan **12 proyek (monorepo, multirepo, dan dokumentasi)** yang telah dibangun. Proyek-proyek di dalam workspace ini mencakup berbagai macam sistem, mulai dari e-commerce multi-role, platform AI untuk UMKM dan mahasiswa STEM, hingga portofolio pribadi bertema retro-futuristik.
...
| 7   | `02-in-progress`        | **[Cake Boss Platform](file:///d:/MY%20CODE/ANTIGRAVITY/02-in-progress/cake-boss-platform)**                              | Platform toko roti digital Surabaya dengan manajemen multi-cabang & aset redesign presisi tinggi.  | Next.js 15, NestJS, Prisma, PostgreSQL, Redis   | Full-Stack (Next.js + NestJS REST API) + UI Assets | Pengembangan UI & Integrasi (Grade B+) |
| 8   | `02-in-progress`        | **[context-forge](file:///d:/MY%20CODE/ANTIGRAVITY/02-in-progress/context-forge)**                                        | Sistem utility context management untuk integrasi LLM & AI.                                        | TypeScript, Node.js                             | Shared Package / Monorepo Tooling                  | Dalam Pengembangan                     |
| 9   | `03-portfolio-showcase` | **[Portfolio Website](file:///d:/MY%20CODE/ANTIGRAVITY/03-portfolio-showcase/portfolio-website)**                         | Website portofolio pribadi retro-futuristik bertema terminal interaktif untuk Ahmad Rizqi Mubarok. | React, Vite, Tailwind CSS, Framer Motion        | Single Page App (SPA)                              | Siap Pakai (Grade B-)                  |
| 10  | `03-portfolio-showcase` | **[tugas-akhir-project-gdgoc-its](file:///d:/MY%20CODE/ANTIGRAVITY/03-portfolio-showcase/tugas-akhir-project-gdgoc-its)** | -                                                                                                  | -                                               | -                                                  | -                                      |
| 11  | `04-experimental`       | **[E-Commerce Web](file:///d:/MY%20CODE/ANTIGRAVITY/04-experimental/e-commerce-web)**                                     | Platform e-commerce Next.js & landing page.                                                        | Next.js (JavaScript/TypeScript)                 | Full-Stack (Next.js)                               | Siap Pakai (Grade B)                   |
| 12  | `06-docs-blueprints`    | **[Venture Blueprint](file:///d:/MY%20CODE/ANTIGRAVITY/06-docs-blueprints/venture-blueprint)**                            | Kumpulan dokumen cetak biru produk, riset pasar, strategi MVP, dan instruksi AI Coding.            | Markdown Documentation                          | Documentation Platform                             | Siap Pakai                             |
