...
Selamat datang di **ANTIGRAVITY Workspace Hub**! Workspace ini dirancang sebagai repositori pusat (monorepo & multirepo hub) yang mengintegrasikan **11 proyek (monorepo, multirepo, dan dokumentasi)** yang telah dibangun. Proyek-proyek di dalam workspace ini mencakup berbagai macam sistem, mulai dari e-commerce multi-role, platform AI untuk UMKM dan mahasiswa STEM, hingga portofolio pribadi bertema retro-futuristik.
...
| 10  | `04-experimental`       | **[E-Commerce Web](file:///d:/MY%20CODE/ANTIGRAVITY/04-experimental/e-commerce-web)**                         | Platform e-commerce Next.js & landing page.                                                        | Next.js (JavaScript/TypeScript)                 | Full-Stack (Next.js)                               | Siap Pakai (Grade B)                   |
| 11  | `06-docs-blueprints`    | **[Venture Blueprint](file:///d:/MY%20CODE/ANTIGRAVITY/06-docs-blueprints/venture-blueprint)**                | Kumpulan dokumen cetak biru produk, riset pasar, strategi MVP, dan instruksi AI Coding.            | Markdown Documentation                          | Documentation Platform                             | Siap Pakai                             |
